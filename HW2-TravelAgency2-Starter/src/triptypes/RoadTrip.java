...
public class RoadTrip extends VacationPackage
{
	...
	/**
	 * The possible fuel efficiency values for the getEstimatedFuelCost() method.
	 */
	...
	{
		double temp = (this.numPeople == 1) 
			? 1.0 : (double) Math.ceil((double) this.numPeople / 2.0);
		return this.basePrice * (double) this.stars * ((double) super.getNumDays() - 1) * temp;
	}
