...
public class Cruise extends FlightOptionalPackage
{
	 ...
	 */
	private final int maxExcursions = 10;
	/**
	 ...
	 * @param basePriceIn The base price for the cheapest tier cabin (interior) on the ship.
	...
	public Cruise(String name, int numDays, String vesselName, String portCity, Calendar departs,
			Calendar returns, double basePriceIn)
	{
		super(name, numDays);
		this.excursionNum = 0;
	...
	{
		return this.getFlightCosts() + this.getLodgingCost() * this.half;
	}
	...
	{
		return this.getFlightCosts() + this.excursionSubTotal + this.getLodgingCost();
	}
	...
	public void addExcursion(String excursion, double price)
	{
		...
		this.excursionSubTotal += (price >= 0) ? price : 0;
	}
